...
def game():
    ...
    b1=Button(game,text=" ",width=30,height=10,relief="raised",command=lambda:play(b1))
    b1.grid(column=1,row=1)
    b2=Button(game,text=" ",width=30,height=10,relief="raised",command=lambda:play(b2))
    b2.grid(column=2,row=1)
    b3=Button(game,text=" ",width=30,height=10,relief="raised",command=lambda:play(b3))
    b3.grid(column=3,row=1)
    b4=Button(game,text=" ",width=30,height=10,relief="raised",command=lambda:play(b4))
    b4.grid(column=1,row=2)
    b5=Button(game,text=" ",width=30,height=10,relief="raised",command=lambda:play(b5))
    b5.grid(column=2,row=2)
    b6=Button(game,text=" ",width=30,height=10,relief="raised",command=lambda:play(b6))
    b6.grid(column=3,row=2)
    b7=Button(game,text=" ",width=30,height=10,relief="raised",command=lambda:play(b7))
    b7.grid(column=1,row=3)
    b8=Button(game,text=" ",width=30,height=10,relief="raised",command=lambda:play(b8))
    b8.grid(column=2,row=3)
    b9=Button(game,text=" ",width=30,height=10,relief="raised",command=lambda:play(b9))
    b9.grid(column=3,row=3)




Button(root,text="continue",width=10,height=1,command=game,relief="raised").grid(row=3,column=1)
